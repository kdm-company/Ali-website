...
- `/company` → `company/index.html`（代表挨拶＝旧HP原文・写真なし構成／会社概要＝事業内容4項目・3工場／沿革／品質方針／アクセス＝地図埋め込み）
...
- 「ALIにできること」を旧HP /about の事業内容に合わせて整理。のちに「マシニングセンターのクーラント清掃」は未実施のため削除し、現在は4項目。
